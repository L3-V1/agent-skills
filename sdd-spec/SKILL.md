...
- Existe um README na raiz ou um `docs/onboarding/ONBOARDING.md` (gerado pela skill `onboarding`,
  se ela já rodou) que já responda parte do contexto de negócio? Leia antes de perguntar, para
