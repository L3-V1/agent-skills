...
- Ao final, informe ao usuário que o pitch pode alimentar a próxima etapa do fluxo de desenvolvimento: `/init-dev` (para configurar o projeto) ou `/sdd` (que conduz a constituição a partir da ideia definida).